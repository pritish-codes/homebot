...
ENV HBOX_DATABASE_SQLITE_PATH=/data/homebot.db?_pragma=busy_timeout=2000&_pragma=journal_mode=WAL&_fk=1&_time_format=sqlite
...
LABEL Name=homebot Version=0.0.1
LABEL org.opencontainers.image.source="https://github.com/pritish-codes/homebot"
